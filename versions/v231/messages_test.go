...
import (
	...
	"github.com/blushift-io/hl7v2/versions/v231"
)
...
func TestMessageMarshal(t *testing.T) {
	...
	if err != nil {
		t.Fatalf("failed to marshal ADT_A01 for 2.3.1: %v", err)
	}
	...
	if err != nil {
		t.Fatalf("failed to parse back marshaled message for 2.3.1: %v", err)
	}

...
//
// Retained for backward compatibility only in version 2.7.  This is used only in the CD Channel Definition data type, which has been retained for backward compatibility only in v2.7.
type CCP struct {
...
//
// Retained for backward compatibility onlyas of v 2.7.  This is used only in the waveform message, CHM category, which has been retained for backward compatibility only in v 2.7.
type CD struct {
...
//
// Retained for backward compatibility only in version 2.6. Fields associated with this data type have been replaced by the ROL segment
type CNN struct {
	IdNumber                                    ST `hl7:"1"`
	FamilyName                                  ST `hl7:"2"`
	GivenName                                   ST `hl7:"3"`
...
// Note: Replaces the CM data type used in 7.14.1.5 OBX-5.3 where OBX-5 Observation value (*) is data type CD as of v 2.5.
//
// Retained for backward compatibility only in version 2.7.  This is used only in the CD Channel Definition data type, which has been retained for backward compatibility only in version 2.7.
//
...
type XON struct {
	...
	IdNumber                 ST  `hl7:"3"`
	IdentifierCheckDigit     ST  `hl7:"4"`
	CheckDigitScheme         ST  `hl7:"5"`

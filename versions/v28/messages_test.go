...
import (
	...
	"github.com/blushift-io/hl7v2/versions/v28"
)
...
func TestMessageMarshal(t *testing.T) {
	...
	if err != nil {
		t.Fatalf("failed to marshal ADT_A01 for v28: %v", err)
	}
	...
	if err != nil {
		t.Fatalf("failed to parse back marshaled message for v28: %v", err)
	}

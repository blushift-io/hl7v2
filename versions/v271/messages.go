...
type CQU_I19_RESOURCEDETAIL struct {
	RESOURCEOBJECT CQU_I19_RESOURCEOBJECT `hl7:"RESOURCE_OBJECT"`
	OBX            []OBX                  `hl7:"OBX"`
}
...
type CQU_I19_ROLEPROBLEM struct {
	ROLEPROBLEMOBJECT CQU_I19_ROLEPROBLEMOBJECT `hl7:"ROLE_PROBLEM_OBJECT"`
	VAR_              []VAR                     `hl7:"VAR"`
}
...
type CQU_I19_ROLEGOAL struct {
	ROALGOALOBJECT CQU_I19_ROALGOALOBJECT `hl7:"ROAL_GOAL_OBJECT"`
	VAR_           []VAR                  `hl7:"VAR"`
}
...
type CQU_I19_ROLEPATHWAY struct {
	ROLEPATHWAYOBJECT CQU_I19_ROLEPATHWAYOBJECT `hl7:"ROLE_PATHWAY_OBJECT"`
	VAR_              []VAR                     `hl7:"VAR"`
}
...
// This section is specifically concerned with describing a master file message that should be used to transmit information which identifies the inventory of healthcare patient locations, such as nursing units, rooms, beds, clinics, exam rooms, etc. In a network environment, this segment can be used to define patient locations to other applications. The segment also includes the readiness states and support locations for the patient locations.
// The LOC, LCH, LRL, LDP, and LCC segments must be preceded by the MFI and MFE segments, as described in Section 8.5, "GENERAL MASTER FILE SEGMENTS."
type MFN_M05 struct {
	MSH        MSH                  `hl7:"MSH,required"`
	SFT        []SFT                `hl7:"SFT"`
	UAC        UAC                  `hl7:"UAC"`
...
type PPT_PCL_PROBLEM struct {
	...
	NTE                []NTE                        `hl7:"NTE"`
	VAR_               []VAR                        `hl7:"VAR"`
	PROBLEMROLE        []PPT_PCL_PROBLEMROLE        `hl7:"PROBLEM_ROLE"`
	PROBLEMOBSERVATION []PPT_PCL_PROBLEMOBSERVATION `hl7:"PROBLEM_OBSERVATION"`
}
...
type PPT_PCL_ORDERDETAIL struct {
	...
	NTE              []NTE                      `hl7:"NTE"`
	VAR_             []VAR                      `hl7:"VAR"`
	ORDEROBSERVATION []PPT_PCL_ORDEROBSERVATION `hl7:"ORDER_OBSERVATION"`
}

type PPT_PCL_ORDER struct {
	ORC         ORC                 `hl7:"ORC,required"`
	ORDERDETAIL PPT_PCL_ORDERDETAIL `hl7:"ORDER_DETAIL"`
}
...
type PPT_PCL_GOAL struct {
	...
	NTE             []NTE                     `hl7:"NTE"`
	VAR_            []VAR                     `hl7:"VAR"`
	GOALROLE        []PPT_PCL_GOALROLE        `hl7:"GOAL_ROLE"`
	GOALOBSERVATION []PPT_PCL_GOALOBSERVATION `hl7:"GOAL_OBSERVATION"`
...
type PPT_PCL_PATHWAY struct {
	...
	NTE         []NTE                 `hl7:"NTE"`
	VAR_        []VAR                 `hl7:"VAR"`
	PATHWAYROLE []PPT_PCL_PATHWAYROLE `hl7:"PATHWAY_ROLE"`
	GOAL        []PPT_PCL_GOAL        `hl7:"GOAL"`
}

type PPT_PCL_PATIENT struct {
	PID          PID                  `hl7:"PID,required"`
	PATIENTVISIT PPT_PCL_PATIENTVISIT `hl7:"PATIENT_VISIT"`
...
type PPV_PCA_PROBLEM struct {
	...
	NTE                []NTE                        `hl7:"NTE"`
	VAR_               []VAR                        `hl7:"VAR"`
	PROBLEMROLE        []PPV_PCA_PROBLEMROLE        `hl7:"PROBLEM_ROLE"`
	PROBLEMOBSERVATION []PPV_PCA_PROBLEMOBSERVATION `hl7:"PROBLEM_OBSERVATION"`
}
...
type PPV_PCA_ORDERDETAIL struct {
	...
	NTE              []NTE                      `hl7:"NTE"`
	VAR_             []VAR                      `hl7:"VAR"`
	ORDEROBSERVATION []PPV_PCA_ORDEROBSERVATION `hl7:"ORDER_OBSERVATION"`
}

type PPV_PCA_ORDER struct {
	ORC         ORC                 `hl7:"ORC,required"`
	ORDERDETAIL PPV_PCA_ORDERDETAIL `hl7:"ORDER_DETAIL"`
}
...
type PPV_PCA_GOAL struct {
	...
	NTE             []NTE                     `hl7:"NTE"`
	VAR_            []VAR                     `hl7:"VAR"`
	GOALROLE        []PPV_PCA_GOALROLE        `hl7:"GOAL_ROLE"`
	GOALPATHWAY     []PPV_PCA_GOALPATHWAY     `hl7:"GOAL_PATHWAY"`
	GOALOBSERVATION []PPV_PCA_GOALOBSERVATION `hl7:"GOAL_OBSERVATION"`
...
type PPV_PCA_PATIENT struct {
	PID          PID                  `hl7:"PID,required"`
	PATIENTVISIT PPV_PCA_PATIENTVISIT `hl7:"PATIENT_VISIT"`
...
type PRR_PC5_GOAL struct {
	...
	NTE             []NTE                     `hl7:"NTE"`
	VAR_            []VAR                     `hl7:"VAR"`
	GOALROLE        []PRR_PC5_GOALROLE        `hl7:"GOAL_ROLE"`
	GOALOBSERVATION []PRR_PC5_GOALOBSERVATION `hl7:"GOAL_OBSERVATION"`
}
...
type PRR_PC5_ORDERDETAIL struct {
	...
	NTE              []NTE                      `hl7:"NTE"`
	VAR_             []VAR                      `hl7:"VAR"`
	ORDEROBSERVATION []PRR_PC5_ORDEROBSERVATION `hl7:"ORDER_OBSERVATION"`
}

type PRR_PC5_ORDER struct {
	ORC         ORC                 `hl7:"ORC,required"`
	ORDERDETAIL PRR_PC5_ORDERDETAIL `hl7:"ORDER_DETAIL"`
}
...
type PRR_PC5_PROBLEM struct {
	...
	NTE                []NTE                        `hl7:"NTE"`
	VAR_               []VAR                        `hl7:"VAR"`
	PROBLEMROLE        []PRR_PC5_PROBLEMROLE        `hl7:"PROBLEM_ROLE"`
	PROBLEMPATHWAY     []PRR_PC5_PROBLEMPATHWAY     `hl7:"PROBLEM_PATHWAY"`
	PROBLEMOBSERVATION []PRR_PC5_PROBLEMOBSERVATION `hl7:"PROBLEM_OBSERVATION"`
...
type PRR_PC5_PATIENT struct {
	PID          PID                  `hl7:"PID,required"`
	PATIENTVISIT PRR_PC5_PATIENTVISIT `hl7:"PATIENT_VISIT"`
...
type PTR_PCF_GOAL struct {
	...
	NTE             []NTE                     `hl7:"NTE"`
	VAR_            []VAR                     `hl7:"VAR"`
	GOALROLE        []PTR_PCF_GOALROLE        `hl7:"GOAL_ROLE"`
	GOALOBSERVATION []PTR_PCF_GOALOBSERVATION `hl7:"GOAL_OBSERVATION"`
}
...
type PTR_PCF_ORDERDETAIL struct {
	...
	NTE              []NTE                      `hl7:"NTE"`
	VAR_             []VAR                      `hl7:"VAR"`
	ORDEROBSERVATION []PTR_PCF_ORDEROBSERVATION `hl7:"ORDER_OBSERVATION"`
}

type PTR_PCF_ORDER struct {
	ORC         ORC                 `hl7:"ORC,required"`
	ORDERDETAIL PTR_PCF_ORDERDETAIL `hl7:"ORDER_DETAIL"`
}
...
type PTR_PCF_PROBLEM struct {
	...
	NTE                []NTE                        `hl7:"NTE"`
	VAR_               []VAR                        `hl7:"VAR"`
	PROBLEMROLE        []PTR_PCF_PROBLEMROLE        `hl7:"PROBLEM_ROLE"`
	PROBLEMOBSERVATION []PTR_PCF_PROBLEMOBSERVATION `hl7:"PROBLEM_OBSERVATION"`
...
type PTR_PCF_PATHWAY struct {
	...
	NTE         []NTE                 `hl7:"NTE"`
	VAR_        []VAR                 `hl7:"VAR"`
	PATHWAYROLE []PTR_PCF_PATHWAYROLE `hl7:"PATHWAY_ROLE"`
	PROBLEM     []PTR_PCF_PROBLEM     `hl7:"PROBLEM"`
}

type PTR_PCF_PATIENT struct {
	PID          PID                  `hl7:"PID,required"`
	PATIENTVISIT PTR_PCF_PATIENTVISIT `hl7:"PATIENT_VISIT"`

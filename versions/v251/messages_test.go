...
import (
	...
	"github.com/blushift-io/hl7v2/versions/v251"
)
...
func TestMessageMarshal(t *testing.T) {
	...
	if err != nil {
		t.Fatalf("failed to marshal ADT_A01 for 2.5.1: %v", err)
	}
	...
	if err != nil {
		t.Fatalf("failed to parse back marshaled message for 2.5.1: %v", err)
	}

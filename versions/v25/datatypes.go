...
func (d *DLD) Validate() error {
	...
	if string(d.DischargeLocation) == "" {
		return fmt.Errorf("DLD.DischargeLocation is required")
	}
...
func (d *ICD) Validate() error {
	...
	if (d.DateTimeCertificationRequired != TS{}) {
		if err := d.DateTimeCertificationRequired.Validate(); err != nil {
			return fmt.Errorf("ICD.DateTimeCertificationRequired: %w", err)
		}
	}
...
func (d *ICD) SetDateTimeCertificationRequired(v TS) *ICD {
	d.DateTimeCertificationRequired = v
	return d
}
...
func (d *MA) SetSample1FromChannelN(v string) *MA {
	d.Sample1FromChannelN = NM(v)
	return d
}
...
func (d *MA) SetSample2FromChannelN(v string) *MA {
	d.Sample2FromChannelN = NM(v)
	return d
}

func (d *MA) SetSampleNFromChannelN(v string) *MA {
	d.SampleNFromChannelN = NM(v)
	return d
}
...
func (d *NA) SetValue5(v string) *NA {
	d.Value5 = NM(v)
	return d
}

func (d *NA) SetValue6(v string) *NA {
	d.Value6 = NM(v)
	return d
}

func (d *NA) SetValue7(v string) *NA {
	d.Value7 = NM(v)
	return d
}

func (d *NA) SetValue8(v string) *NA {
	d.Value8 = NM(v)
	return d
}

func (d *NA) SetValue9(v string) *NA {
	d.Value9 = NM(v)
	return d
}

func (d *NA) SetValue10(v string) *NA {
	d.Value10 = NM(v)
	return d
}
...
func (d *PPN) Validate() error {
	...
	if (d.EffectiveDate != TS{}) {
		if err := d.EffectiveDate.Validate(); err != nil {
			return fmt.Errorf("PPN.EffectiveDate: %w", err)
		}
	}

	if (d.ExpirationDate != TS{}) {
		if err := d.ExpirationDate.Validate(); err != nil {
			return fmt.Errorf("PPN.ExpirationDate: %w", err)
		}
	}
...
func (d *PPN) SetEffectiveDate(v TS) *PPN {
	d.EffectiveDate = v
	return d
}

func (d *PPN) SetExpirationDate(v TS) *PPN {
	d.ExpirationDate = v
	return d
}
...
func (d *PRL) SetParentObservationIdentifier(v CE) *PRL {
...
func (d *TS) Validate() error {
	...
	if string(d.Time) == "" {
		return fmt.Errorf("TS.Time is required")
	}
...
func (d *XAD) Validate() error {
	...
	if (d.EffectiveDate != TS{}) {
		if err := d.EffectiveDate.Validate(); err != nil {
			return fmt.Errorf("XAD.EffectiveDate: %w", err)
		}
	}

	if (d.ExpirationDate != TS{}) {
		if err := d.ExpirationDate.Validate(); err != nil {
			return fmt.Errorf("XAD.ExpirationDate: %w", err)
		}
	}
...
func (d *XAD) SetEffectiveDate(v TS) *XAD {
	d.EffectiveDate = v
	return d
}

func (d *XAD) SetExpirationDate(v TS) *XAD {
	d.ExpirationDate = v
	return d
}
...
func (d *XCN) Validate() error {
	...
	if (d.EffectiveDate != TS{}) {
		if err := d.EffectiveDate.Validate(); err != nil {
			return fmt.Errorf("XCN.EffectiveDate: %w", err)
		}
	}

	if (d.ExpirationDate != TS{}) {
		if err := d.ExpirationDate.Validate(); err != nil {
			return fmt.Errorf("XCN.ExpirationDate: %w", err)
		}
	}
...
func (d *XCN) SetEffectiveDate(v TS) *XCN {
	d.EffectiveDate = v
	return d
}

func (d *XCN) SetExpirationDate(v TS) *XCN {
	d.ExpirationDate = v
	return d
}
...
func (d *XPN) Validate() error {
	...
	if (d.EffectiveDate != TS{}) {
		if err := d.EffectiveDate.Validate(); err != nil {
			return fmt.Errorf("XPN.EffectiveDate: %w", err)
		}
	}

	if (d.ExpirationDate != TS{}) {
		if err := d.ExpirationDate.Validate(); err != nil {
			return fmt.Errorf("XPN.ExpirationDate: %w", err)
		}
	}
...
func (d *XPN) SetEffectiveDate(v TS) *XPN {
	d.EffectiveDate = v
	return d
}

func (d *XPN) SetExpirationDate(v TS) *XPN {
	d.ExpirationDate = v
	return d
}
